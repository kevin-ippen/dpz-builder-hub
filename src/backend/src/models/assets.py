...
class AssetRead(AssetBase):
    ...
    created_at: datetime
    updated_at: datetime
    # DPZ lifecycle dimensions
    maturity: Optional[str] = Field(None, description="Lifecycle maturity: idea|triaged|poc|validating|production_candidate|production")
    delivery_status: Optional[str] = Field(None, description="Delivery: unfunded|proposed|funded|in_delivery|delivered|cancelled")
    operational_health: Optional[str] = Field(None, description="Health: unknown|healthy|degraded|unsupported|retired")
    publication_scope: Optional[str] = Field(None, description="Scope: draft|private|team|enterprise|withdrawn")
    value_hypothesis: Optional[str] = Field(None, description="What value does this asset deliver?")
    demo_url: Optional[str] = Field(None, description="Live demo URL")
    repo_url: Optional[str] = Field(None, description="Source repository or workspace path")
    originator: Optional[str] = Field(None, description="Original author/team")
...
class AssetSummary(BaseModel):
    ...
    operational_health: Optional[str] = None
